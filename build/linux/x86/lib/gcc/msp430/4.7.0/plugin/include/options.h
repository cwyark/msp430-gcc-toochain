...
enum opt_code
{
  ...
  OPT_mc16 = 982,                            /* -mc16 */
  OPT_mc20 = 983,                            /* -mc20 */
  OPT_mcode_region_ = 984,                   /* -mcode-region= */
  OPT_mcpu_ = 985,                           /* -mcpu= */
  OPT_md16 = 986,                            /* -md16 */
  OPT_md20 = 987,                            /* -md20 */
  OPT_mdata_region_ = 988,                   /* -mdata-region= */
  OPT_mdisable_watchdog = 989,               /* -mdisable-watchdog */
  OPT_menable_libcall_shift = 990,           /* -menable-libcall-shift */
  OPT_misr20 = 991,                          /* -misr20 */
  OPT_mivcnt_ = 992,                         /* -mivcnt= */
  OPT_mmcu_ = 993,                           /* -mmcu= */
  OPT_mmemory_model_ = 994,                  /* -mmemory-model= */
  OPT_mmpy_ = 995,                           /* -mmpy= */
  OPT_mnoint_hwmul = 996,                    /* -mnoint-hwmul */
  OPT_msr16 = 997,                           /* -msr16 */
  OPT_msr20 = 998,                           /* -msr20 */
  OPT_n = 999,                               /* -n */
  OPT_no_canonical_prefixes = 1000,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1001,              /* -no-integrated-cpp */
  OPT_nocpp = 1002,                          /* -nocpp */
  OPT_nodefaultlibs = 1003,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1004,                   /* -nostartfiles */
  OPT_nostdinc = 1005,                       /* -nostdinc */
  OPT_nostdinc__ = 1006,                     /* -nostdinc++ */
  OPT_nostdlib = 1007,                       /* -nostdlib */
  OPT_o = 1008,                              /* -o */
  OPT_p = 1009,                              /* -p */
  OPT_pass_exit_codes = 1010,                /* -pass-exit-codes */
  OPT_pedantic = 1011,                       /* -pedantic */
  OPT_pedantic_errors = 1012,                /* -pedantic-errors */
  OPT_pg = 1013,                             /* -pg */
  OPT_pie = 1014,                            /* -pie */
  OPT_pipe = 1015,                           /* -pipe */
  OPT_print_file_name_ = 1016,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1017,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1018,          /* -print-multi-directory */
  OPT_print_multi_lib = 1019,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1020,       /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 1021,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1022,               /* -print-prog-name= */
  OPT_print_search_dirs = 1023,              /* -print-search-dirs */
  OPT_print_sysroot = 1024,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1025,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1026,                          /* -quiet */
  OPT_r = 1027,                              /* -r */
  OPT_remap = 1028,                          /* -remap */
  OPT_s = 1029,                              /* -s */
  OPT_s_bc_abi = 1030,                       /* -s-bc-abi */
  OPT_save_temps = 1031,                     /* -save-temps */
  OPT_save_temps_ = 1032,                    /* -save-temps= */
  OPT_shared = 1033,                         /* -shared */
  OPT_shared_libgcc = 1034,                  /* -shared-libgcc */
  /* OPT_specs = 1035, */                    /* -specs */
  OPT_specs_ = 1036,                         /* -specs= */
  OPT_static = 1037,                         /* -static */
  OPT_static_libgcc = 1038,                  /* -static-libgcc */
  OPT_static_libgcj = 1039,                  /* -static-libgcj */
  OPT_static_libgfortran = 1040,             /* -static-libgfortran */
  OPT_static_libgo = 1041,                   /* -static-libgo */
  OPT_static_libstdc__ = 1042,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1043, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1044, */                /* -std=c++0x */
  OPT_std_c__11 = 1045,                      /* -std=c++11 */
  OPT_std_c__98 = 1046,                      /* -std=c++98 */
  OPT_std_c11 = 1047,                        /* -std=c11 */
  /* OPT_std_c1x = 1048, */                  /* -std=c1x */
  /* OPT_std_c89 = 1049, */                  /* -std=c89 */
  OPT_std_c90 = 1050,                        /* -std=c90 */
  OPT_std_c99 = 1051,                        /* -std=c99 */
  /* OPT_std_c9x = 1052, */                  /* -std=c9x */
  OPT_std_f2003 = 1053,                      /* -std=f2003 */
  OPT_std_f2008 = 1054,                      /* -std=f2008 */
  OPT_std_f2008ts = 1055,                    /* -std=f2008ts */
  OPT_std_f95 = 1056,                        /* -std=f95 */
  OPT_std_gnu = 1057,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1058, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1059, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1060,                    /* -std=gnu++11 */
  OPT_std_gnu__98 = 1061,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1062,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1063, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1064, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1065,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1066,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1067, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1068, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1069,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1070, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1071, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1072, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1073,                     /* -std=legacy */
  OPT_symbolic = 1074,                       /* -symbolic */
  OPT_t = 1075,                              /* -t */
  OPT_time = 1076,                           /* -time */
  OPT_time_ = 1077,                          /* -time= */
  OPT_traditional = 1078,                    /* -traditional */
  OPT_traditional_cpp = 1079,                /* -traditional-cpp */
  OPT_trigraphs = 1080,                      /* -trigraphs */
  OPT_u = 1081,                              /* -u */
  OPT_undef = 1082,                          /* -undef */
  OPT_v = 1083,                              /* -v */
  OPT_version = 1084,                        /* -version */
  OPT_w = 1085,                              /* -w */
  OPT_wrapper = 1086,                        /* -wrapper */
  OPT_x = 1087,                              /* -x */
  OPT_z = 1088,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
